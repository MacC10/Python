...
if __name__ == '__main__':
    ...
    new_body.add_tag("p", "Unlike <strong>composition</strong> aggregation uses existing istances"
                     " of objects to build up another obj.")
    new_body.add_tag("p", "The composed obj doesn't actually own the obj that it's composed of"
                     " - if it's destroyed, those obj continue to exist.")
    new_docType = DocType()
