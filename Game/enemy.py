from config import fullhp  # fullhp2
import random
...
class VampireKing(Vampire):
    ...
    def take_damage(self, damage):
        ...
        # remaining_points = self._hit_points - (damage//4)
        # if remaining_points >= 0:
        #     self._hit_points = remaining_points
        #     print("I took {} points damage and have {} left".format(damage//4, self._hit_points))
        # else:
        #     self._lives -= 1
        #     if self._lives != 0:
        #         self._hit_points = fullhp2
        #     else:
        #         pass
        #     if self._lives > 0:
        #         print("{0._name} lost a life".format(self))
